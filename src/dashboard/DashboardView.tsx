            ...
            <div className="card" style={{
              ...
              <div style={{ fontSize: '11px', color: 'var(--accent-color)', fontWeight: 500, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
                  <AlertTriangle size={13} /> Please do not touch, scroll, or switch tabs while WebForge is capturing the page.
                </div>
        ...
        {status === 'success' && activePage && (
          <>
            ...
            <aside style={{
              ...
              {/* Captured Source Assets summary */}
              <div>
                <h3 style={{ margin: '0 0 12px 0', fontSize: '14px', fontWeight: 600, borderBottom: '1px solid var(--border-color)', paddingBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> Captured Source Assets
                </h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '12px', marginBottom: '8px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 6px', background: 'var(--bg-hover)', borderRadius: '4px' }}>
                    <span style={{ color: 'var(--text-secondary)' }}>HTML Layout:</span>
                    <strong style={{ color: 'var(--text-primary)' }}>{activePage.assets?.html ? '1 index.html' : '0 files'}</strong>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 6px', background: 'var(--bg-hover)', borderRadius: '4px' }}>
                    <span style={{ color: 'var(--text-secondary)' }}>CSS Stylesheets:</span>
                    <strong style={{ color: 'var(--text-primary)' }}>{((activePage.assets?.inlineStyles?.length || 0) + (activePage.assets?.externalStyles?.length || 0))} files</strong>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 6px', background: 'var(--bg-hover)', borderRadius: '4px' }}>
                    <span style={{ color: 'var(--text-secondary)' }}>JS Scripts:</span>
                    <strong style={{ color: 'var(--text-primary)' }}>{((activePage.assets?.inlineScripts?.length || 0) + (activePage.assets?.externalScripts?.length || 0))} files</strong>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 6px', background: 'var(--bg-hover)', borderRadius: '4px' }}>
                    <span style={{ color: 'var(--text-secondary)' }}>Media & SVGs:</span>
                    <strong style={{ color: 'var(--text-primary)' }}>{activePage.assets?.media?.length || 0} items</strong>
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginTop: 'auto', paddingTop: '16px', borderTop: '1px solid var(--border-color)' }}>
                <a 
                  ...
                  rel="noreferrer" 
                  className="button"
                  style={{ width: '100%', justifyContent: 'center', gap: '6px', fontSize: '12px', padding: '8px', background: 'var(--bg-hover)', color: 'var(--text-primary)', textDecoration: 'none', borderRadius: '8px', display: 'flex', alignItems: 'center' }}
                >
