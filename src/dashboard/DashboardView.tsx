...
export default function DashboardView() {
  ...
  const [status, setStatus] = useState<
    "idle" | "capturing" | "crawling" | "error" | "success"
  >("idle");
  ...
  const startJob = async (
    ...
    if (action === "capture") {
      ...
      setProgressBar(5);
      const res = await chrome.runtime.sendMessage({
        action: "START_RESPONSIVE_CAPTURE",
        tabId,
      });
      if (res && res.success) {
        setPages([
  ...
  const availableViewports = activePage
    ? Object.keys(activePage.screenshots).filter(
        (k) => activePage.screenshots[k as keyof typeof activePage.screenshots],
      )
    : [];
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <AlertTriangle size={13} /> Please do not touch, scroll, or
                  switch tabs while WebForge is capturing the page.
                </div>
        ...
        {status === "error" && (
          ...
          >
            ...
            >
              <AlertTriangle
                size={32}
                style={{ color: "#c0392b", marginBottom: "12px" }}
              />
              <h3
                style={{
                  margin: "0 0 8px 0",
                ...
                {pages.map((page, index) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      const viewports = Object.keys(page.screenshots).filter(
                        (k) =>
                          page.screenshots[k as keyof typeof page.screenshots],
                      );
                      if (
                        viewports.length > 0 &&
                        !viewports.includes(activeViewport)
                      ) {
                    ...
                    >
                      ...
                      >
                        <rect
                          ...
                          ry="2"
                        ></rect>
                        <circle cx="12" cy="17" r="0.75"></circle>
                      </svg>{" "}
                      Tablet (768)
                    </button>
                  )}
              ...
              >
                ...
                >
                  {activePage.screenshots[activeViewport] ? (
                    ...
                    >
                      Viewport not captured. Start responsive scan to unlock
                      this view.
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--text-primary)" }}>
                      {activePage.assets?.html ? "1 index.html" : "0 files"}
                    </strong>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--text-primary)" }}>
                      {(activePage.assets?.inlineStyles?.length || 0) +
                        (activePage.assets?.externalStyles?.length || 0)}{" "}
                      files
                    </strong>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--text-primary)" }}>
                      {(activePage.assets?.inlineScripts?.length || 0) +
                        (activePage.assets?.externalScripts?.length || 0)}{" "}
                      files
                    </strong>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--text-primary)" }}>
                      {activePage.assets?.media?.length || 0} items
                    </strong>
                  </div>
                </div>
              </div>
